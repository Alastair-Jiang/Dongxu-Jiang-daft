...
M3 扩池重测 ✅ 2026-08-16  Ridge 100 IC 0.048/Sharpe +0.53;
                           DAFT 100 IC 0.037/平滑 −0.60 → 有条件 GO 预判
M4 稳健性验证 🔄 进行中    换手控制✅(freq=5+zscore Sharpe +0.25 转正)/
                           --full 证伪✅/walk-forward✅(折间不稳, 训练量敏感)/
                           ⏳ 消融归因 + 长历史训练 + 成本真实性重测
M5 判定 ⬜ (09-30 前)      判定书草稿已出(docs/DECISION_20260930.md):
                           预判暂定 NO-GO(架构) 方向
```
